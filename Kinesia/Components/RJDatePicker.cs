...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Kinesia.Properties.Resources.calendarWhitesmall;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                else calendarIcon = Kinesia.Properties.Resources.calendarWhitesmall;
                this.Invalidate();
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (StringFormat textFormat = new StringFormat())
            {
                ...
                //Draw icon
                graphics.DrawImage(calendarIcon, this.Width - calendarIcon.Width - 9, (this.Height - calendarIcon.Height) / 4);
